    ...
    return (
        <div className="projects-div">
            <div className="farmer-div-1">
                ...
                <h3>Needed: 500000 Naira<ProgressBar value={60} max={100} className="okoro1-progress-bar" /></h3>
            ...
            <div className="farmer-div-2" >
                ...
                <h3>Needed: 200000 Naira<ProgressBar value={90} max={100} className="uche1-progress-bar" /></h3>
            ...
            <div className="farmer-div-3" >
                ...
                <h3>Needed: 800000 Naira<ProgressBar value={38} max={100} className="adaobi1-progress-bar" /></h3>
                <h5>Raised: 300000 Naira</h5>
            </div>
            ...
            <div className="farmer-div-4">
                ...
                <h1>Okoro Fish Farm</h1>
                <p>Mechanized fish farm with dryer for preservation after harvesting</p>
                <h3>Needed: 500000 Naira<ProgressBar value={60} max={100} className="okoro2-progress-bar" /></h3>
                <h5>Raised: 300000 Naira</h5>
            </div>
            ...
            <div className="farmer-div-5" >
                ...
                <h1>Adaobi Rice Farm</h1>
                <p>Mechanized Rice farm with boiler and dryer ready for processing</p>
                <h3>Needed: 800000 Naira<ProgressBar value={38} max={100} className="adaobi2-progress-bar" /></h3>
                <h5>Raised: 300000 Naira</h5>
            </div>
            ...
            <div className="farmer-div-6" >
                ...
                <h1>Uche Cassava Farm</h1>
                <p>Mechanized cassava farm with dryer and grinder for processing</p>
                <h3>Needed: 200000 Naira<ProgressBar value={90} max={100} className="uche2-progress-bar" /></h3>
                <h5>Raised: 180000 Naira</h5>
            </div>
        </div>
    )
